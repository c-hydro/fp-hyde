...
def compute_rain(var_dframe, var_attrs=None,
                 var_name_time='time',
                 var_type='accumulated', var_period=None, var_frequency='1H',
                 var_decimals=3,
                 **kwargs):
...
def compute_air_temperature(var_dframe, var_attrs=None,
                            var_name_time='time',
                            var_type='instantaneous', var_period=None, var_frequency='1H',
                            **kwargs):
...
def compute_surface_albedo(var_dframe, var_attrs=None,
    ...
    # check frequency
    if var_frequency != '3H':
        alg_logger.error(' ===> Surface Albedo frequency must be "3H"')
        raise NotImplementedError('Case not implemented yet')
