...
"""
HYDE Downloading Tool - ODBC Weather Stations
...
python3 hyde_downloader_odbc_ws.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version:
20201028 (3.0.0) --> Release 3.0 Beta (HyDE package)
20150925 (2.0.7) --> Release 2.0 Stable (Regione Marche Operational Chain)
20150325 (2.0.0) --> Release 2.0 Beta (Regione Marche Operational Chain)
20140401 (1.0.1) --> Release 1.0 Stable (DRIHM2US Project)
20131201 (1.0.0) --> Release 1.0 Beta (DRIHM2US Project)
"""
# -------------------------------------------------------------------------------------
...
from bin.downloader.ws.odbc.lib_utils_io import read_file_settings
from bin.downloader.ws.odbc.lib_utils_system import make_folder
from bin.downloader.ws.odbc.lib_utils_time import set_time

from bin.downloader.ws.odbc.drv_downloader_ws_geo import DriverGeo
from bin.downloader.ws.odbc.drv_downloader_ws_data import DriverData
...
alg_name = 'HYDE DOWNLOADING TOOL - ODBC WEATHER STATIONS'
alg_version = '3.0.0'
alg_release = '2020-10-28'
