...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE RUNNER - HSAF ASCAT MOD [ECMWF-RZSM] REALTIME - NRT'
script_version="1.0.0"
script_date='2019/08/27'
...
script_file='/home/hsaf/hyde-master/apps/hsaf/soil_moisture/HYDE_DynamicData_HSAF_ASCAT_MOD_NRT.py'
setting_file='/home/hsaf/hyde-master/apps/hsaf/soil_moisture/hyde_configuration_hsaf_ascat_mod_nrt_realtime.json'

# Get information (-u to get gmt time)
time_now=$(date -u +"%Y%m%d%H00")
# time_now='201908260000' # DEBUG
#-----------------------------------------------------------------------------------------
