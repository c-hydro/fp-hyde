...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE RUNNER - HSAF H13'
...
script_file='/home/hsaf/hyde-master/apps/hsaf/snow/HYDE_DynamicData_HSAF_H13.py'
setting_file='/home/hsaf/hyde-master/apps/hsaf/snow/hyde_configuration_hsaf_h13_realtime.json'
