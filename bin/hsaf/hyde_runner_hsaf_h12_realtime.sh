...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE RUNNER - HSAF H12'
...
script_file='/home/hsaf/hyde-master/apps/hsaf/snow/HYDE_DynamicData_HSAF_H12.py'
setting_file='/home/hsaf/hyde-master/apps/hsaf/snow/hyde_configuration_hsaf_h12_realtime.json'
