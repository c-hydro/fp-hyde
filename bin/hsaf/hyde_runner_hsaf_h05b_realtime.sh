...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE RUNNER - HSAF H05B'
...
script_file='/home/hsaf/hyde-master/apps/hsaf/precipitation/HYDE_DynamicData_HSAF_H05B.py'
setting_file='/home/hsaf/hyde-master/apps/hsaf/precipitation/hyde_configuration_hsaf_h05b_realtime.json'
