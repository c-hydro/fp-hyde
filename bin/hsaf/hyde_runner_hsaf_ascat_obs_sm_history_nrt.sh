...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE RUNNER - HSAF ASCAT OBS [METOP-SM] HISTORY - NRT'
...
setting_file='/home/hsaf/hyde-master/apps/hsaf/soil_moisture/hyde_configuration_hsaf_ascat_obs_nrt_history.json'
