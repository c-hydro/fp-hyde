...
setting_file='/share/c-hydro/hyde-master/apps/rfarm/hyde_configuration_rfarm_history_wrf.json'

env_flag=false

file_lock_start_raw='rf_model_wrf_lock_%YYYY%MM%DD%HH00_history_START.txt'
file_lock_end_raw='rf_model_wrf_lock_%YYYY%MM%DD%HH00_history_END.txt'
