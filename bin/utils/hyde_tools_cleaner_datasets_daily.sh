...
"/hydro/run/weather_stations_state/" 
"/hydro/run/nwp_lami-2i_realtime/"
"/hydro/run/nwp_ecmwf0100_realtime/"
"/hydro/run/rfarm_lami-2i_realtime/"
"/hydro/run/rfarm_ecmwf0100_realtime/"
"/hydro/run/rfarm_expert_forecast_realtime/")
