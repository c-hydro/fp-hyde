...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE RUNNER - GROUND NETWORK WS'
...
setting_file='/home/hsaf/hsaf_op_chain/apps/ground_network/ws/hyde_configuration_groundnetwork_ws_realtime.json'
