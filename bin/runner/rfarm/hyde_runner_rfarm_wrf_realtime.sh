...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE RUNNER - MODEL RFARM - REALTIME'
script_version="1.5.2"
script_date='2019/10/14'
...
# SERVER
script_file='/share/c-hydro/hyde-master/apps/rfarm/HYDE_Model_RFarm.py'
setting_file='/share/c-hydro/hyde-master/apps/rfarm/hyde_configuration_rfarm_realtime_wrf.json'

env_flag=true

file_lock_start_raw='rf_model_wrf_lock_%YYYY%MM%DD%HH00_realtime_START.txt'
file_lock_end_raw='rf_model_wrf_lock_%YYYY%MM%DD%HH00_realtime_END.txt'
...
# time_system="2019-10-16 05:55" # DEBUG
#-----------------------------------------------------------------------------------------
