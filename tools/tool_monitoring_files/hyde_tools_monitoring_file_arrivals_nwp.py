...
folders_to_watch = [
    f"/hydro/data/data_dynamic/source/nwp/ecmwf0100/",
    f"/hydro/data/data_dynamic/source/nwp/lami-2i/",
    f"/hydro/data/data_dynamic/source/nwp/icon-2i/"
]
...
# Configure logging
logging.basicConfig(filename=os.path.join(log_folder, "file_arrivals_nwp.log"), level=logging.INFO, 
...
class MyHandler(FileSystemEventHandler):
    def on_created(self, event):
        ...
        csv_file = os.path.join(csv_folder, f"file_arrivals_nwp_{time.strftime('%Y-%m-%d')}.csv")
