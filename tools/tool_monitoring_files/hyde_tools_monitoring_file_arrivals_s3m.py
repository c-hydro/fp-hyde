...
folders_to_watch = [
    f"/hydro/data/data_dynamic/source/s3m/abruzzo/{current_year}/",
    f"/hydro/data/data_dynamic/source/s3m/emilia_romagna/{current_year}/",
    f"/hydro/data/data_dynamic/source/s3m/lazio/{current_year}/",
    f"/hydro/data/data_dynamic/source/s3m/marche/{current_year}/",
    f"/hydro/data/data_dynamic/source/s3m/toscana/{current_year}/",
    f"/hydro/data/data_dynamic/source/s3m/umbria/{current_year}/"
]

# Define the folder where log and csv files will be saved
...
# Configure logging
logging.basicConfig(filename=os.path.join(log_folder, "file_arrivals_s3m.log"), level=logging.INFO, 
...
class MyHandler(FileSystemEventHandler):
    def on_created(self, event):
        ...
        csv_file = os.path.join(csv_folder, f"file_arrivals_s3m_{time.strftime('%Y-%m-%d')}.csv")
