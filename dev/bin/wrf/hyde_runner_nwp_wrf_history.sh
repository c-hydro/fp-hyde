...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE RUNNER - NWP WRF - HISTORY'
...
settings_file='/share/c-hydro/hyde-master/apps/wrf/hyde_configuration_nwp_wrf_barbados_history.json'

env_flag=false

file_lock_start_raw='nwp_dynamicdata_wrf_lock_%YYYY%MM%DD%HH00_history_START.txt'
file_lock_end_raw='nwp_dynamicdata_wrf_lock_%YYYY%MM%DD%HH00_history_END.txt'
