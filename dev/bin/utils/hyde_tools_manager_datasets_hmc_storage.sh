...
group_datasets_name=(
    "DYNAMIC DATA - STATE GRIDDED"
    "DYNAMIC DATA - STATE POINT"
    "DYNAMIC DATA - HYDROGRAPH TIME-SERIES JSON - WEATHER STATIONS"
    "DYNAMIC DATA - HYDROGRAPH TIME-SERIES JSON - RADAR MCM"
    "DYNAMIC DATA - HYDROGRAPH TIME-SERIES JSON - NWP ECMWF0100"
    "DYNAMIC DATA - HYDROGRAPH TIME-SERIES JSON - NWP LAMI-2I"
    "DYNAMIC DATA - HYDROGRAPH TIME-SERIES JSON - RFARM ECMWF0100"
    "DYNAMIC DATA - HYDROGRAPH TIME-SERIES JSON - RFARM LAMI-2I"
    "DYNAMIC DATA - HYDROGRAPH TIME-SERIES JSON - RFARM EXPERT FORECAST"
)

group_folder_datasets_source_raw=(
    "/hydro/archive/model_dset_restart/gridded/" 
    "/hydro/archive/model_dset_restart/point/"
    "/hydro/archive/weather_stations_realtime/%YYYY/%mm/%dd/%HH/collections/"
    "/hydro/archive/radar_mcm_realtime/%YYYY/%mm/%dd/%HH/collections/"
    "/hydro/archive/nwp_ecmwf0100_realtime/%YYYY/%mm/%dd/%HH/collections/"
    "/hydro/archive/nwp_lami-2i_realtime/%YYYY/%mm/%dd/%HH/collections/"
    "/hydro/archive/rfarm_ecmwf0100_realtime/%YYYY/%mm/%dd/%HH/probabilistic_ensemble/collections/"
    "/hydro/archive/rfarm_lami-2i_realtime/%YYYY/%mm/%dd/%HH/probabilistic_ensemble/collections/"
    "/hydro/archive/rfarm_expert_forecast_realtime/%YYYY/%mm/%dd/%HH/probabilistic_ensemble/collections/"
)

group_folder_datasets_destination_raw=(
    "/hydro/storage/model_dset_restart/gridded/%YYYY/%mm/%dd/" 
    "/hydro/storage/model_dset_restart/point/%YYYY/%mm/%dd/"
    "/hydro/storage/weather_stations_realtime/%YYYY/%mm/%dd/%HH/"
    "/hydro/storage/radar_mcm_realtime/%YYYY/%mm/%dd/%HH/"
    "/hydro/storage/nwp_ecmwf0100_realtime/%YYYY/%mm/%dd/%HH/"
    "/hydro/storage/nwp_lami-2i_realtime/%YYYY/%mm/%dd/%HH/"
    "/hydro/storage/rfarm_ecmwf0100_realtime/%YYYY/%mm/%dd/%HH/"
    "/hydro/storage/rfarm_lami-2i_realtime/%YYYY/%mm/%dd/%HH/"
    "/hydro/storage/rfarm_expert_forecast_realtime/%YYYY/%mm/%dd/%HH/"
)
