...
# Execution example:
# python3 HYDE_DynamicData_NWP_LAMI-2I.py -settings_file hyde_dynamicdata_nwp_lami-2i.json -time "2020-11-02 12:00"
#-----------------------------------------------------------------------------------------

#-----------------------------------------------------------------------------------------
# Get script information
script_file='HYDE_DynamicData_NWP_LAMI-2I.py'
settings_file='hyde_configuration_nwp_lami-2i_example.json'
...
folder_data_raw='/hydro/data/data_dynamic/source/nwp/lami-2i/'
