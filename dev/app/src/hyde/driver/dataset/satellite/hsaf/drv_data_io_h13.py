        ...
        for sVarKey, oVarData in oVarWS.items():
            ...
            if oVarWS[sVarKey] is not None:
                ...
                if ('values' in oVarData) and ('attributes' in oVarData):
                    ...
                    # Debug
                    # plt.figure()
                    # plt.imshow(a2dVarValue); plt.colorbar(); plt.clim(-1, 10)
                    # plt.figure()
                    # plt.imshow(a2dVarValue_INTERP); plt.colorbar(); plt.clim(-1, 10)
                    # plt.figure()
                    # plt.imshow(a2dVarValue_FILTER); plt.colorbar(); plt.clim(-1, 10)
                    # plt.show()
                    # -------------------------------------------------------------------------------------
