...
"""
HYDE APP - GROUND WEATHER STATIONS PRODUCT  - HYdrological Data Engines
...
python app_obs_ws_main.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version:
20241015 (3.1.0) --> Update code(s) for HYdE package
...
from drv_configuration_algorithm_ws import DriverAlgorithm
from drv_configuration_time_ws import DriverTime

from drv_data_ws_geo import DriverGeo
from drv_data_ws_io import DriverData
# -------------------------------------------------------------------------------------
...
alg_project = 'hyde'
alg_name = 'Application for processing ground network weather station(s)'
alg_version = '3.1.0'
alg_release = '2024-10-15'
alg_type = 'Package'
