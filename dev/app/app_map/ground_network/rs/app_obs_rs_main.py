...
"""
HYDE APP - GROUND RIVER STATIONS PRODUCT  - HYdrological Data Engines
...
Version:
20241015 (2.1.0) --> Update code(s) for HYdE package
...
from drv_configuration_algorithm_rs import DriverAlgorithm
from drv_configuration_time_rs import DriverTime

from drv_data_rs_geo import DriverGeo
from drv_data_rs_io import DriverData
# -------------------------------------------------------------------------------------
...
alg_project = 'hyde'
alg_name = 'Application for processing ground network river station(s)'
alg_version = '2.1.0'
