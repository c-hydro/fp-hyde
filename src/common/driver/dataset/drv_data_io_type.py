...
class Drv_Data_IO:
    ...
    def __init__(self, sFileName, sFileMode=None, sFileType=None):
        ...
        if sFileName.endswith('txt') or sFileName.endswith('asc') or (sFileExt == 'txt'):
            
            sFileType = 'ascii'
            self.oFileWorkspace = FileAscii(sFilePath, sFileName, sFileType, sFileMode)

        elif sFileName.endswith('nc') or (sFileExt == 'nc'):
        ...
        elif sFileName.endswith('csv') or (sFileExt == 'csv'):

            sFileType = 'csv'
            self.oFileWorkspace = FileCSV(sFilePath, sFileName, sFileType, sFileMode)

        elif sFileName.endswith('shp'):
