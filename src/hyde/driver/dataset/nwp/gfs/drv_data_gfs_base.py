...
from src.hyde.algorithm.utils.nwp.gfs.lib_gfs_generic import fill_tags2string, flat_dictionary
from src.hyde.algorithm.settings.nwp.gfs.lib_gfs_args import logger_name, time_units, time_format, time_calendar
from src.hyde.driver.dataset.nwp.gfs.drv_data_gfs_io import DataReader, DataWriter
from src.hyde.driver.dataset.nwp.gfs.drv_data_gfs_exec import DataComposer
...
class DataProductBuilder:
    ...
    def __init__(self, time_run, time_range,
        ...
        self.file_tag_geo_x = 'lon'
        self.file_tag_geo_y = 'lat'
        self.file_tag_time = 'time'
        ...
        for file_key_step, file_path_step in file_data_in.items():
            ...
            data_tags_in_values = {'datetime_source': self.time_run, 'runtime_source': self.time_run,
                                   'sub_path_time_source': self.time_run, 'domain': self.data_domain}
        ...
        if self.file_availability:
            ...
            self.driver_data_reader = DataReader(
                ...
                file_tag_geo_x=self.file_tag_geo_x, file_tag_geo_y=self.file_tag_geo_y,
            ...
            self.driver_data_composer = DataComposer(
                ...
                file_tag_geo_x=self.file_tag_geo_x, file_tag_geo_y=self.file_tag_geo_y, file_tag_time=self.file_tag_time
            )
