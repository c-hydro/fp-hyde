...
from src.hyde.driver.dataset.nwp.ecmwf.cpl_data_variables_ecmwf_0100 import DataVariables, ModelVariables
...
class DataComposer:
    ...
    def __init__(self,
        ...
        self.var_tag_terrain = tag_geo_terrain
        self.var_tag_geo_x = tag_geo_y
        self.var_tag_geo_y = tag_geo_x

        self.file_tag_units = 'GRIB_units'
        self.file_tag_step_type = 'GRIB_stepType'
        self.file_tag_time = 'valid_time'
