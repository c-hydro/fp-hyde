...
import src.hyde.dataset.radar.lib_mcm_variables as fx_collections
...
class DriverVariable:
    ...
    def __init__(self, var_obj, ref_obj, var_attributes=None,
        ...
        self.fx_nodata, self.fx_interp_method = self.get_fx_attributes()
    ...
    def filter_var_valid_range(self, var_dset, var_nodata=-9999.0):
    ...
    def get_fx_attributes(self):
        ...
        fx_nodata = -1
        if 'no_data' in list(self.fx_parameters.keys()):
            fx_nodata = self.fx_parameters['no_data']
        fx_interp_method = 'nearest'
        if 'interp_method' in list(self.fx_parameters.keys()):
            fx_interp_method = self.fx_parameters['interp_method']

        return fx_nodata, fx_interp_method
    ...
    def compute_data(self, ref_geo_index=None):
        ...
        var_obj = deepcopy(self.filter_var_valid_range(self.var_obj, var_nodata=-9999.0))
        ...
        if self.fx_obj:
            ...
            fx_data = {'var_data': var_obj[self.tag_var_data].values,
                       ...
                       'fx_nodata': self.fx_nodata, 'fx_interp_method': self.fx_interp_method,
