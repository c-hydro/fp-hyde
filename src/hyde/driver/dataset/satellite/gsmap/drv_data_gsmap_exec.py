...
from src.hyde.driver.dataset.satellite.gsmap.cpl_data_variables_gsmap import DataVariables, ModelVariables
...
class DataComposer:
    ...
    def __init__(self,
                 ...
                 var_tag_geo_terrain='terrain', var_tag_interp='nearest',
                 var_tag_geo_x='geo_x', var_tag_geo_y='geo_y', var_tag_time='time',
                 file_tag_coord_geo_x='longitude', file_tag_coord_geo_y='latitude', file_tag_coord_time='time',
                 file_tag_dim_geo_x='longitude', file_tag_dim_geo_y='latitude', file_tag_dim_time='time'
                 ):
        ...
        self.var_tag_interp = var_tag_interp
    ...
    def execute(self, var_data):
        ...
        file_tag_coord_geo_x = self.file_tag_coord_geo_x
        file_tag_coord_geo_y = self.file_tag_coord_geo_y

        file_tag_dim_time = self.file_tag_dim_time
        file_tag_dim_geo_x = self.file_tag_dim_geo_x
        file_tag_dim_geo_y = self.file_tag_dim_geo_y

        var_frame = {}
        for (info_key, info_step), (time_key, time_range_step) in zip(self.var_info.items(), self.var_time.items()):
            ...
            if 'var_method_compute' in list(info_step.keys()):
                ...
                driver_var_cmp = DataVariables(info_key=info_key, var_name=var_name,
                                               ...
                                               file_tag_coord_time=file_tag_coord_time,
                                               file_tag_coord_geo_x=file_tag_coord_geo_x,
                                               file_tag_coord_geo_y=file_tag_coord_geo_y,
                                               file_tag_dim_time=file_tag_dim_time,
                                               file_tag_dim_geo_x=file_tag_dim_geo_x,
                                               file_tag_dim_geo_y=file_tag_dim_geo_y
                                               )
                ...
                var_da_masked = driver_var_cmp.configure_data(var_data_raw,
                                                              var_time_period_raw, time_range_step,
                                                              var_interp=self.var_tag_interp)
