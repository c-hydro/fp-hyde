...
from src.hyde.algorithm.settings.satellite.modis.lib_modis_conventions import conventions_vars

from src.hyde.algorithm.io.satellite.modis.lib_modis_io_generic import write_obj, read_obj, convert_values2da, \
    create_dset, write_dset, read_file_hdf4
from src.hyde.algorithm.utils.satellite.modis.lib_modis_generic import make_folder, fill_tags2string, list_folder, \
    get_root_path

from src.hyde.algorithm.analysis.satellite.modis.lib_modis_analysis_interpolation_grid import interp_grid2index

from src.hyde.algorithm.io.satellite.modis.lib_modis_io_gzip import zip_filename, unzip_filename
                ...
                for var_key, var_fields in var_src_dict.items():
                    ...
                    if var_mode:
                        ...
                        if os.path.exists(var_file_unzip_src):
                            var_file_data_src = read_file_hdf4(var_file_unzip_src, var_name=var_name)
