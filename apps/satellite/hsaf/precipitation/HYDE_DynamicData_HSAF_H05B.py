"""
HSAF Processing Tool - PRECIPITATION PRODUCT H05B
...
python3 HYDE_DynamicData_HSAF_H05B.py -settings_file configuration.json -time YYYYMMDDHHMM
...
Version:
20191004 (3.0.4) --> Hyde package refactor
20190418 (3.0.3) --> Use source data in netcdf format and add quality index
20190401 (3.0.2) --> Fix bug about geographical references of grib file(s) and interpolation method
20180823 (3.0.0) --> Beta release to put algorithm into FloodProofs library
20141204 (2.0.0) --> Release starting on version 1.0.0
"""
# -------------------------------------------------------------------------------------
...
from src.hyde.driver.dataset.satellite.hsaf.drv_data_io_h05b import DataProductCleaner, DataProductTime, \
...
def main():
    ...
    sProgramVersion = '3.0.4'
    sProjectName = 'HYDE'
    sAlgType = 'DataDynamic'
    sAlgName = 'HSAF PROCESSING TOOL H05B'
    ...
    for sTimeStep in oData_Time['a1oTimeStep']:
        ...
        oDrv_DataBuilder_Dynamic = DataProductBuilder(
            time=oTimeStep,
            settings=oData_Settings,
            rain_file_hh_03=defineString(oData_Path['rain_data_hh_03'],
                                             removeDictKey(oData_Tags, ['Year', 'Month', 'Day', 'Hour', 'Minute'])),
            rain_file_hh_06=defineString(oData_Path['rain_data_hh_06'],
                                             removeDictKey(oData_Tags, ['Year', 'Month', 'Day', 'Hour', 'Minute'])),
            rain_file_hh_12=defineString(oData_Path['rain_data_hh_12'],
                                             removeDictKey(oData_Tags, ['Year', 'Month', 'Day', 'Hour', 'Minute'])),
            rain_file_hh_24=defineString(oData_Path['rain_data_hh_24'],
                                             removeDictKey(oData_Tags, ['Year', 'Month', 'Day', 'Hour', 'Minute'])),
        )
