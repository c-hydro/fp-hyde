...
python3 HYDE_DynamicData_HSAF_ASCAT_MOD_NRT.py -settings_file configuration.json -time YYYYMMDDHHMM

Version(s) history in changelog file
"""
...
def main():
    ...
    alg_name = 'HSAF PROCESSING TOOL ASCAT MOD NRT'
