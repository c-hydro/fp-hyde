...
python3 HYDE_DynamicData_HSAF_H12.py -settings_file configuration.json -time YYYYMMDDHHMM
...
from src.hyde.driver.dataset.satellite.hsaf.drv_data_io_h12 import DataProductBuilder, DataProductAnalyzer, \
...
def main():
    ...
    sAlgName = 'HSAF PROCESSING TOOL H12'
