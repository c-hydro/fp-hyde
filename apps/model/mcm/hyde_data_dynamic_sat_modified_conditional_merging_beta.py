...
from src.hyde.driver.model.griso.drv_model_griso_exec_beta import GrisoCorrel, GrisoInterpola, GrisoExec
...
def main():
    ...
    if data_settings['algorithm']['flags']["sources"]['use_timeseries']:
