...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE DYNAMICDATA - SATELLITE SMAP - DROUGH INDEX SWDI'
script_version="1.0.0"
script_date='2020/05/11'

script_folder='/home/sequia/drought/code/SWDI/'
...
script_file='HYDE_DynamicData_DroughtIndex_SWDI.py'
setting_file='hyde_configuration_drought_index_swdi_server_realtime.json'
