"""
HyDE Processing Tool - NWP ECMWF 0100
...
python HYDE_DynamicData_NWP_ECMWF_0100.py -settings_file configuration.json -time YYYYMMDDHHMM

Version(s):
20200210 (3.0.0) --> Beta release for hyde package
20170510 (2.5.0) --> Updated version
20150923 (2.0.4) --> Previous version based on operational chain mode
"""
# -------------------------------------------------------------------------------------
...
from src.hyde.algorithm.settings.nwp.ecmwf.lib_ecmwf_args import logger_formatter, logger_handle, logger_name

from src.hyde.driver.configuration.nwp.ecmwf.drv_configuration_time_ecmwf import DataTime
from src.hyde.driver.dataset.nwp.ecmwf.drv_data_ecmwf_geo import DataGeo

from src.hyde.driver.configuration.generic.drv_configuration_algorithm import DataAlgorithm
from src.hyde.driver.dataset.nwp.ecmwf.drv_data_ecmwf_base import DataProductTime, DataProductBuilder
# -------------------------------------------------------------------------------------
...
def main():
    ...
    alg_name = 'NWP ECMWF 0100 Processing Tool'
    ...
    for time_step in data_algorithm_time['time_steps']:
        ...
        driver_product = DataProductBuilder(
            ...
            file_ancillary_analyzing=data_algorithm_path['nwp_analyzing_ancillary'],
        ...
        data_dynamic_collected = driver_product.collect(data_dynamic_time)
