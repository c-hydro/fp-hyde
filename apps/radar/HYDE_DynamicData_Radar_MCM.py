"""
Radar Processing Tool - PRECIPITATION MCM PRODUCT
...
python3 HYDE_DynamicData_Radar_MCM.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version:
20201206 (1.5.0) --> Hyde package refactor
20190709 (1.0.0) --> Beta release
"""
# -------------------------------------------------------------------------------------
...
from src.hyde.driver.configuration.radar.drv_configuration_algorithm_mcm import DriverAlgorithm
from src.hyde.driver.configuration.radar.drv_configuration_time_mcm import DriverTime

from src.hyde.driver.dataset.radar.drv_data_mcm_geo import DriverGeo
from src.hyde.driver.dataset.radar.drv_data_mcm_io import DriverData
# -------------------------------------------------------------------------------------

# -------------------------------------------------------------------------------------
# Algorithm information
alg_project = 'HyDE'
alg_name = 'RADAR PROCESSING TOOL PRECIPITATION MCM'
alg_version = '1.5.0'
alg_release = '2020-12-06'
