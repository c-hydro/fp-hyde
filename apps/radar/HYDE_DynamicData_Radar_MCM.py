"""
Radar Processing Tool - PRECIPITATION PRODUCT MCM
...
python3 HYDE_DynamicData_Radar_MCM.py -settingfile configuration_product.json -time YYYYMMDDHHMM
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'hyde_configuration_radar_mcm.json'
...
def main():
    ...
    sAlgName = 'RADAR PROCESSING TOOL MCM'
